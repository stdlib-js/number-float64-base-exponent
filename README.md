...
```javascript
exponent = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-exponent@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-exponent@umd/bundle.js"></script>
```
