...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/number-float64-base-exponent/tags). For example,

```javascript
exponent = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-exponent@v0.2.1-umd/browser.js' )
```
